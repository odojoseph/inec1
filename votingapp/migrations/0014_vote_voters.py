# Generated by Django 2.2.3 on 2019-09-28 07:56
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('votingapp', '0013_auto_20190928_0851'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voters', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='votingapp.Voters')),
            ],
            options={
                'db_table': 'voteresult',
                'ordering': ['party'],
