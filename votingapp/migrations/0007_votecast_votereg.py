# Generated by Django 2.2.3 on 2019-09-06 06:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('votereg_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='votingapp.VoteReg')),
            ],
            options={
                'unique_together': {('user', 'votereg_id')},
            },
        ),
    ]
